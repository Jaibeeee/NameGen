var names = [
  "Ramen Monster", "Worm", "Mother of Dorks", "Poopy", "CEB!",
  "Hot Mess Express", "Cheeto von Tweeto", "Longing-eyes Von Gimmefood",
  "The Nugget Queen", "Pickle","The Lone Ranger", "Danger Noodle",
  "Secret Weapon", "The Internet Explorer",
  "Bumblebee Pudding Pants", "Fartacus", "Minion Queen",
  ...
  "Bec-naldo", "Lionel Bessi", "BEC-HAM", "Miss Tea", "Chewbacca",
  ...
  "4 Eyes", "Bird Lady", "Small Fry", "Shorty", "Weirdo",
  ...
  "Colossus", "Muggle", "Goober", "Nerd", "Oddball", "Big Cheddar",
  "Garbage Gut Destroyer", "Egg Roll", "Turtle Neck", "Frazzle Mc FrazzleFace",
